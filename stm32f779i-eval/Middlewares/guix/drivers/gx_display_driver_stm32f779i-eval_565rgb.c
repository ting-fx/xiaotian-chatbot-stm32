...
__attribute__((section(".SD_RAM"))) static USHORT frame_buffer[STM32F779I_EVAL_SCREEN_WIDTH][STM32F779I_EVAL_SCREEN_HEIGHT];
...
INT          width;
    ...
    if (_gx_utility_rectangle_overlap_detect(&dirty, &composite -> gx_canvas_dirty_area, &overlap))
    {
        ...
        gx_dma_init(DMA2D_M2M, (uint32_t) write, STM32F779I_EVAL_SCREEN_WIDTH - width, width, overlap.gx_rectangle_bottom - overlap.gx_rectangle_top + 1);
...
ULONG *put;
    ...
    if (gx_utility_rectangle_overlap_detect(&Limit, &canvas->gx_canvas_dirty_area, &Copy))
    {
        ...
        offset = (canvas->gx_canvas_display_offset_y + Copy.gx_rectangle_top)* STM32F779I_EVAL_SCREEN_WIDTH;
        ...
        #if defined(GX_CHROMEART_ENABLE)
        gx_dma_init(DMA2D_M2M, (uint32_t) put, STM32F779I_EVAL_SCREEN_WIDTH - copy_width, copy_width, copy_height);
        ...
        dest_stride_ulongs = STM32F779I_EVAL_SCREEN_WIDTH / 2;
...
UINT stm32f779_graphics_driver_setup_565rgb(GX_DISPLAY *display)
{
    ...
    */
    _gx_display_driver_565rgb_setup(display, (VOID*)STM32F779I_EVAL_SCREEN_HANDLE, stm32f746_565rgb_buffer_toggle);
    ...
    memset(frame_buffer, 0, STM32F779I_EVAL_SCREEN_WIDTH * STM32F779I_EVAL_SCREEN_HEIGHT * 2);
